...
이 포트폴리오 저장소는 아래와 같이 5개의 핵심 프로젝트로 구성되어 있습니다. 각 프로젝트 폴더 내부의 `README.md` 파일에서 각 시스템의 상세 아키텍처 및 흐름도(Flowchart)를 확인하실 수 있습니다.

### 1. [Google Drive Uploader](projects/google-drive-uploader/)
* **개요**: 웹 브라우저 상에서 로컬 파일을 구글 드라이브의 원하는 폴더로 직접 다중 업로드할 수 있는 반응형 웹 애플리케이션입니다.
* **주요 기술**: HTML5, CSS3, JavaScript (ES6+), Google Identity Services (OAuth 2.0), Google Drive REST API v3.

### 2. [AI Collaborative Robot Assistant - LAMA (춘식아 해줘)](projects/lama/)
...
### 3. [Braille Recognition & AMR Control](projects/braille/)
...
### 4. [Museum Security Guard (박살팀)](projects/find_thief/)
...
### 5. [NVIDIA Isaac Sim Robot Workspace](projects/isaac/)
