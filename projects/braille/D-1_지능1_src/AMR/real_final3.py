...
INITIAL_POSE_POSITION = [-0.71, -0.75]
...
MY_START_PATROL_TOPIC = '/robot2/start_patrol_signal'
PEER_START_PATROL_TOPIC = '/robot8/start_patrol_signal'

MY_THIEF_POSITION_TOPIC = '/robot2/thief_position'
PEER_THIEF_POSITION_TOPIC = '/robot8/thief_position'

AMCL_POSE_TOPIC = '/robot2/amcl_pose'
NAV_ACTION_NAME = '/robot2/navigate_to_pose'

ARRIVE_POSITION_TOPIC = '/robot2/arrive_position'
